...
namespace ProjectMonitors.Monitor.App.Sites.Asus
{
  ...
  public class AsusFetcherFactory : ProductStatusFetcherFactoryBase
  {
    ...
    public AsusFetcherFactory(IServiceProvider serviceProvider, IJsonSerializer jsonSerializer,
    ...
    {
      return new AsusFetcher(_monitorHttpClientFactory.CreateHttpClient(), target.Input, _jsonSerializer);
    }
  }
}