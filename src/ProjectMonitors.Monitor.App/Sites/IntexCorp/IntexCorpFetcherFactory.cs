...
namespace ProjectMonitors.Monitor.App.Sites.IntexCorp
{
  ...
  public class IntexCorpFetcherFactory : ProductStatusFetcherFactoryBase
  {
    ...
    public IntexCorpFetcherFactory(IServiceProvider serviceProvider, IMonitorHttpClientFactory monitorHttpClientFactory)
    ...
    {
      return new IntexCorpFetcher(_monitorHttpClientFactory.CreateHttpClient(), new Uri(target.Input));
    }
  }
}