...
namespace ProjectMonitors.Monitor.App.Sites.Shopify
{
  ...
  public class ShopifyFetcherFactory : ProductStatusFetcherFactoryBase
  {
    ...
    public ShopifyFetcherFactory(IServiceProvider serviceProvider, IJsonSerializer jsonSerializer,
    ...
    {
      return new ShopifyFetcher(_monitorHttpClientFactory.CreateHttpClient(), target.Input, _jsonSerializer);
    }
  }
}